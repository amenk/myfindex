...
All.Group=<table border%3D0 cellpadding%3D0 cellspacing%3D0 width%3D%2250%25%22>%0D%0A{GroupedCols}%0D%0A</table>%0D%0A%0D%0A<table border%3D0>%0D%0A<tr class%3D%22header%22>{ColHeader}</tr>%0D%0A{FILES}%0D%0A</table>%0D%0A
All.Group.File=<tr class%3D%22e%22>{COLUMNS}</tr>
All.Group.File.Column=<td>{Text}</td>
